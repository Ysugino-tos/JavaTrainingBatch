...
billing_ym DATE PRIMARY NOT NULL KEY REFERENCES T_BILLING_STATUS(billing_ym),
member_id INTEGER PRIMARY KEY NOT NULL REFERENCES T_MEMBER(member_id),
...
billing_ym DATE PRIMARY KEY NOT NULL REFERENCES T_BILLING_DATA(billing_ym),
member_id INTEGER PRIMARY KEY NOT NULL REFERENCES T_BILLING_DATA(member_id),
